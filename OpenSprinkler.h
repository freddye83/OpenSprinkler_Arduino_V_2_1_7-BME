...
//These are now included in OpenSprinkler_Arduino.h
//#include "Time.h"
//#include "DS1307RTC.h"
...
public:
  ...
  static char temp[10];
  static char pression[12];
  static char humidite[10];
    ...
    // Added for debugging - prints the current free memory
    // and an animated character to show activity
    static void lcd_print_memory(byte line); 
