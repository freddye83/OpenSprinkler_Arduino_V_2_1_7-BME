...
void server_json_status_main() {
  ...
  //bfill.emit_p(PSTR("],\"nstations\":$D}"), os.nstations);
    ...
    bfill.emit_p ( PSTR ( "],\"nstations\":$D" ), os.nstations );
    bfill.emit_p ( PSTR ( ",\"temp\":$S" ), os.temp);
    bfill.emit_p ( PSTR ( ",\"press\":$S" ), os.pression);
    bfill.emit_p ( PSTR ( ",\"hum\":$S}" ), os.humidite);
    DEBUG_PRINTLN(os.temp);
    DEBUG_PRINTLN(os.pression);
    DEBUG_PRINTLN(os.humidite);
#else
      bfill.emit_p ( PSTR ( "],\"nstations\":$D}" ), os.nstations );
#endif
